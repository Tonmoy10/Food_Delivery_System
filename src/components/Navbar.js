            ...
            <nav className='relative flex flex-wrap items-center justify-between px-2 py-3 mb-3 bg-violet-500 '>
                <div className='container flex flex-wrap items-center justify-between px-4 mx-auto'>
                    <div className='relative flex justify-between w-full lg:w-auto lg:static lg:block lg:justify-start'>
                        <a className='inline-block py-2 mr-4 font-mono text-xl font-bold leading-relaxed text-white uppercase whitespace-nowrap' href='#p'>
                            XYZ FOOD
                        </a>
                        <button className='block px-3 py-1 text-xl leading-none text-white bg-transparent border border-transparent border-solid rounded outline-none cursor-pointer lg:hidden focus:outline-none' type='button' onClick={() => setNavbarOpen(!navbarOpen)}>
