        ...
        <div className='flex'>
            ...
            <div className='flex flex-col flex-1 h-screen overflow-y-hidden '>
                <div className='flex items-center justify-between h-16 px-6 bg-gray-100 border-b border-gray-400 shadow shadow-slate-500'>
                    <div className='text-xl font-bold text-gray-900'>{customer.customer_name}'s Details</div>
                ...
                <div className='flex'>
                    <div className='w-2/4 mt-16 ml-24 shadow shadow-slate-800 h-96'>
                        <div className='flex items-center w-full h-16 px-6 mt-8 ml-12 text-2xl font-bold tracking-wide'>{customer.customer_name}</div>
                        <div className='ml-28'>
                            <div className='flex mt-4 ml-2 text-xl font-semibold tracking-wide'>
                                Customer ID: <span>CUS-{customer.customer_id}</span>
                            </div>
                            <div className='flex mt-4 ml-2 text-xl font-semibold tracking-wide'>Email: {customer.email}</div>
                            <div className='flex mt-4 ml-2 text-xl font-semibold tracking-wide'>Contact: {customer.contact}</div>
                        </div>
                    </div>
