                    ...
                    <div className='p-6 overflow-x-hidden'>
                        <form action=''>
                            ...
                            <div className='relative pb-4'>
                                <label htmlFor='name' className='absolute text-sm font-bold text-gray-900 uppercase'>
                                    Name
                                </label>
                            ...
                            <div className='flex justify-end'>
                                ...
                                <button className='px-4 py-2 text-white bg-gray-800 rounded hover:bg-blue-900'>Add New Employee</button>
                            </div>
                        </form>
                    </div>
                </div>
